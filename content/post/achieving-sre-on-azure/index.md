...
![Azure Back To School](screenshots/screenshot-2023-09-09-acdd4560.png)
...
![Intro to SRE on Azure](screenshots/screenshot-2023-09-09-bd3fc024.png)
...
- And sometimes, itâ€™s figuring out how t apply existing solutions to new problems

![Role of an SRE](screenshots/screenshot-2023-09-09-ec8a0e88.png)
...
![Is SRE like DevOps 2.0](screenshots/screenshot-2023-09-09-4a4dca00.png)
...
![Measure SRE success](screenshots/screenshot-2023-09-09-9345cd39.png)

- **SLO** â€“ service level objective, which refers to the target reliability for a given workload
- **SLI** â€“ works together with SLO; this identifies what is the right percentage of the reliability target
- **RTO** â€“ Recovery Time Objective â€“ refers to the amount of time it takes to fix an issue and got a workload up-and-running again
- **RPO** â€“ Recovery Point Objective, which defines the point to where you could recover, meaning what is the foreseeable data loss

![Measure SRE success](screenshots/screenshot-2023-09-09-0b048774.png)

Specifically for measuring downtime and outages, the following 4 are important:

- **MTTF** â€“ Mean Time To failure â€“ how long does it take before something breaks
- **MTBF** â€“ Mean Time Between failure â€“ how long before the next outage occurs
- **MTTR** â€“ Mean Time To Repair â€“ how long to fix it
- **MTTA** â€“ Mean Time To Acknowledge â€“ how long to detect an outage
...
![Azure Shared Responsibilities](screenshots/screenshot-2023-09-09-97bb4716.png)
...
![Azure Shared Responsibilities](screenshots/screenshot-2023-09-09-3100b3ee.png)

![Azure Status Health](screenshots/screenshot-2023-09-09-d0b0abc5.png)
**Azure Status**: overall Azure Status Health

![Azure Service Health](screenshots/screenshot-2023-09-09-8b8ec3db.png)
**Service Health**: Personalized view of your Azure Services and Regions in use

![Azure Resource Health](screenshots/screenshot-2023-09-09-01925894.png)
...
![Azure Well-Architected Framework Overview](screenshots/screenshot-2023-09-09-d6810edb.png)
...
![Azure Well-Architected Framework Overview](screenshots/screenshot-2023-09-09-9eaae510.png)

![Azure Well-Architected Framework Overview](screenshots/screenshot-2023-09-09-2963b934.png)
...
![Azure DevOps](screenshots/screenshot-2023-09-09-d9aaa5c8.png)
...
[![BuyMeACoffee](screenshots/screenshot-2023-09-09-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
