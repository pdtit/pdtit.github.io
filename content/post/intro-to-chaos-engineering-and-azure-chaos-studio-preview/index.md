...
Chaos Engineering is all about experimenting *â€“ typically against production-running systemsâ€“* to identify and find loopholes, pitfalls if you want, in the way the system is running, which makes the system less reliable.
The more loopholes we can identify upfront, the more confidence we can have in the systemâ€™s reliability. By introducing a series of event simulations, whether based on real incidents happened earlier or based on simulated outages that could happen, we target our workloads and learn from its impact.
...
![Chaos Monkey Logo](screenshots/screenshot-2023-08-27-f4513d5f.png)
...
Azure Chaos Studio is provided *as a service*, which means you donâ€™t have to deploy your own infrastructure first to get it up and running. **Azure Chaos Studio Preview** is a fully managed chaos engineering experimentation platform for accelerating discovery of hard-to-find problems, from late-stage development through production. Disrupt your apps and its corresponding Azure resources (Virtual Machines, Network Security Groups, App Services, Cosmos DB, Azure Kubernetes Service, Azure KeyVault and more...) intentionally to identify gaps and plan mitigations before your users or customers are impacted by a problem.
...
1. The first thing you need to check is to make sure the **â€œMicrosoft.Chaosâ€ Azure Resource Provider** is enabled (registered) in your subscription. To do that, open your Azure portal, and search for Subscriptions.

2. Select the subscription in which you want to enable Azure Chaos Studio. From within the detailed blade, select â€œResource Providersâ€ under the Settings pane, and search for â€œChaosâ€. Select â€œMicrosoft.Chaosâ€ and click â€œRegisterâ€ in the top menu; give it a few minutes, until the Status column shows â€œRegisteredâ€.

![Microsoft Chaos Resource Provider](screenshots/screenshot-2023-08-27-3dba02fd.png)
...
![Chaos Studio MI](screenshots/screenshot-2023-08-27-b7925536.png)
...
![Chaos App Insights](screenshots/screenshot-2023-08-27-79f3265f.png)

6. From the Azure Portal, search for **Azure Chaos Studio**. 

![Welcome to Chaos Studio](screenshots/screenshot-2023-08-27-8edd1900.png)

7. Select **Onboard Resources**. This brings you to the **Targets** section of the blade.

![Chaos Studio Targets](screenshots/screenshot-2023-08-27-52ecf869.png)
...
1. In this example, Iâ€™m going to target a Windows Server Virtual machine, selecting it, which unlocks the â€œEnable Targetsâ€ menu option. From here, select **Enable agent-based targets (VM, VMSS)** from the menu.

![Chaos Studio VM Target](screenshots/screenshot-2023-08-27-936a94a1.png)
...
![Chaos Studio VM Agent Target](screenshots/screenshot-2023-08-27-3a266713.png)
...
![Chaos Studio non-VM Agent Target](screenshots/screenshot-2023-08-27-3b3c9221.png)

This opens the Enable service direct targets blade. Click **Review and Enable** to complete the step. 

![Chaos Studio non-VM Agent Target](screenshots/screenshot-2023-08-27-1d3b4fde.png)
...
![Chaos Studio Experiment](screenshots/screenshot-2023-08-27-db463abf.png)
...
![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-8f2775b2.png)
...
![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-ffa6feca.png)

4. Click **Next** to open the **Experiment Designer**

![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-a37f8e43.png)
...
![Chaos Studio Faults](screenshots/screenshot-2023-08-27-0e39d2a6.png)
...
![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-0486f59f.png)

6. Next, allocate the Azure Target Resource. In our example, select the VM you deployed earlier as sample target.

![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-470851fe.png)

7. A new Experiment Resource got created.

![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-a0323747.png)
...
![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-215d46e9.png)
...
![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-bdb604db.png)
...
![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-6578869d.png)

11. Wait for the Experiment to change to **Running** state.

![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-28c874a1.png)
...
![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-ffbe69ab.png)
...
![Chaos Studio Experiment Basics](screenshots/screenshot-2023-08-27-53ec94b1.png)
...
[![BuyMeACoffee](screenshots/screenshot-2023-08-27-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
