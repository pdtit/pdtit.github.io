...
![App Service Error](screenshots/screenshot-2023-04-30-7ee9ef2d.png)
...
![Publish task hang](screenshots/screenshot-2023-04-30-362a9b94.png)

So this was not really helping me further. Time to open up the **App Service Logs** settings on the App Service to dig in. 

![App Service Logs](screenshots/screenshot-2023-04-30-fcd5cd96.png)
...
![Verbose Logs](screenshots/screenshot-2023-04-30-c84b1a42.png)
...
![Verbose Logs](screenshots/screenshot-2023-04-30-6441cd5c.png)
...
![App Service Release settings](screenshots/screenshot-2023-04-30-d5f9ccf8.png)
...
![Select ZIP package](screenshots/screenshot-2023-04-30-d58a914e.png)

![Zip Package Selected](screenshots/screenshot-2023-04-30-76c00f92.png)

With these new changes, let's run the release deployment again and see what happens...

![Actual files got deployed](screenshots/screenshot-2023-04-30-7d693d7c.png)
...
[![BuyMeACoffee](screenshots/screenshot-2023-04-30-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
