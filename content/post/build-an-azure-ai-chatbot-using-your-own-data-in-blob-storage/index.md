...
![Azure OpenAI Studio](screenshots/screenshot-2023-07-17-ddfb8eee.png)
...
![Azure OpenAI Resource](screenshots/screenshot-2023-07-17-9a216e8d.png)

4. Wait for the Azure OpenAI Resource to get deployed, and navigate to the resource once its ready.

![Azure OpenAI Resource](screenshots/screenshot-2023-07-17-9435dc38.png)
...
![Azure OpenAI Studio](screenshots/screenshot-2023-07-17-23c291bb.png)

6. From Azure OpenAI Studio, select **Chat Playground** from the **Get Started** options.

![Azure OpenAI Chat Playground](screenshots/screenshot-2023-07-17-6337eff8.png)

7. Within the **Chat Playground**, click the **Create new deployment** button to set up a new Chat Plaground.

![Azure OpenAI Chat Playground](screenshots/screenshot-2023-07-17-dca9553e.png)
...
![Deploy Model](screenshots/screenshot-2023-07-17-e194d150.png)
...
![Chat Playground add your data](screenshots/screenshot-2023-07-17-7d1a86c6.png)
...
![Chat Playground add your data](screenshots/screenshot-2023-07-17-01070d5a.png)
...
![Create Cognitive search resource](screenshots/screenshot-2023-07-17-d179c90c.png)
...
![Chat Playground add your own data](screenshots/screenshot-2023-07-17-6a33f151.png)

7. Click **Next**, and upload a few sample files in the **Upload Files** step.

![Chat Playground upload files data](screenshots/screenshot-2023-07-17-8b05f521.png)

8. Continue the **add data source** wizard steps, and completing with clicking **Save and Close**.

![Chat Playground upload files data](screenshots/screenshot-2023-07-17-d64210cb.png)
...
![Chat Playground chat session](screenshots/screenshot-2023-07-17-37f398b9.png)
...
![Deploy Chat Bot to Azure App Service](screenshots/screenshot-2023-07-17-29de58ea.png)
...
![Deploy Chat Bot to Azure App Service](screenshots/screenshot-2023-07-17-afa0d73e.png)
...
![Deployed Chat Bot as Azure App Service](screenshots/screenshot-2023-07-17-7219ed8d.png)
...
![Deployed Chat Bot as Azure App Service](screenshots/screenshot-2023-07-17-669866e4.png)
...
[![BuyMeACoffee](screenshots/screenshot-2023-07-17-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
