...
![](screenshots/screenshot-2022-12-28-17b867b3.png)
...
![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-43adf04d.png)
...
![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-b6b8b213.png)
...
![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-e4316da5.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-5bda58f3.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-b39e2d5f.png)
...
![Graphical user interface, text, application, chat or text message Description automatically generated](screenshots/screenshot-2022-12-28-6fb7c0fd.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-5597d98d.png)
...
![Graphical user interface, application, Word Description automatically generated](screenshots/screenshot-2022-12-28-f5dada3f.png)
...
![](screenshots/screenshot-2022-12-28-6788d303.png)
...
![](screenshots/screenshot-2022-12-28-4a039c22.png)
...
![A picture containing text Description automatically generated](screenshots/screenshot-2022-12-28-5e5050fc.png)
...
![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-adae2fdd.png)
  
18. Click Edit for now, since we will add more code to the Page.

Add the following @code section below the HTML/CSS layout

![A picture containing application Description automatically generated](screenshots/screenshot-2022-12-28-07a7400b.png)
...
![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-86c4d3e3.png)
...
![](screenshots/screenshot-2022-12-28-1733bb6a.png)
...
2.  Enter the name of a Marvel character, for example â€œthorâ€, which will move that to the Output console. This confirms both the bind-value property as well as the search button and corresponding action behind it is working as it should be.  
    ...
    ![Text Description automatically generated](screenshots/screenshot-2022-12-28-034bab2a.png)
...
![A screenshot of a video game Description automatically generated](screenshots/screenshot-2022-12-28-4f9a2349.png)
...
![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-47c6d979.png)
...
![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-50eb88c8.png)

![Text Description automatically generated](screenshots/screenshot-2022-12-28-2265117a.png)

![](screenshots/screenshot-2022-12-28-427ba28a.png)

![Graphical user interface, text Description automatically generated](screenshots/screenshot-2022-12-28-360bd5d8.png)

1.  Click the â€œTry it outâ€ button. The result shows the outcome + the exact URL that was used:

![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-4d64c949.png)
...
![](screenshots/screenshot-2022-12-28-08a184a6.png)
...
![A picture containing scatter chart Description automatically generated](screenshots/screenshot-2022-12-28-205804b2.png)
...
![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-b1527a23.png)
...
![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-31bb1d9b.png)
...
![Text Description automatically generated](screenshots/screenshot-2022-12-28-2e723304.png)

1.  In the VStudio project, create a new folder â€œModelsâ€, and add a new Item in there, called MarvelResult.cs

![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-23f4f21c.png)
...
![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-7c0fddc6.png)

![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-15e86484.png)
...
```
![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-5db56d68.png)

![Graphical user interface, text Description automatically generated](screenshots/screenshot-2022-12-28-a5365d8d.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-05985c35.png)

Where now the Class gets nicely recognized

![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-bcd88ae6.png)
...
![Graphical user interface, application Description automatically generated with medium confidence](screenshots/screenshot-2022-12-28-0cfdaa1e.png)
...
![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-16a09be9.png)
...
```
![Text Description automatically generated](screenshots/screenshot-2022-12-28-5b80a746.png)
...
![Graphical user interface, website Description automatically generated](screenshots/screenshot-2022-12-28-88de5977.png)
...
1.  Open flip.razor page; First thing we need to change, is the Page Routing, pointing to the â€œ/flipâ€ routing directory instead of the â€œ/â€, as that one is linked to the index.razor page.  
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-9b7d28f8.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-5ee912eb.png)
...
1.  Next, we add a class for the flip-card-back, where we will show the Marvel character name and description.   
    ...
    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-1ecbeef2.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-e436e152.png)

1.  Search for a character, and see the outcome cards:

![Graphical user interface Description automatically generated](screenshots/screenshot-2022-12-28-efb1bdd8.png)
...
![Text Description automatically generated](screenshots/screenshot-2022-12-28-12f7b192.png)
...
![Chart Description automatically generated with medium confidence](screenshots/screenshot-2022-12-28-e8c45d2f.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-2ce3432b.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-65ecbfd6.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2022-12-28-72687fbb.png)
...
![A screenshot of a computer Description automatically generated with medium confidence](screenshots/screenshot-2022-12-28-36962b2d.png)
...
1.  From the Azure Portal, create new resource / static web app  
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-4aae45d5.png)
...
-   Region = any region of your choice
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-62941ae1.png)
...
1.  Scroll down and authenticate to GitHub; Next, select your source repo in Github where the code is stored (the one we just created)
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-dbd525c0.png)
...
2.  Click Build Details to provide more parameters regarding the Blazor app itself. Note you need to change the default App location from /Client to /, since our source code is in the root of the Blazor Web Assembly, without using ASP.Net hosted back-end.
    ...
    ![Graphical user interface, application, email Description automatically generated](screenshots/screenshot-2022-12-28-a5c753e9.png)

3.  Once published, it will trigger a GitHub Actions pipeline to publish the actual content

    ![](screenshots/screenshot-2022-12-28-d30b17e9.png)
...
4.  The YAML pipeline code is stored in the .github/workflows/ subfolder within the GitHub repository. You shouldnâ€™t need to update this file though. It just works out-of-the-box.
    ...
    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-65639483.png)

5.  Check in Actions whatâ€™s happening:

    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-f50eb218.png)

6.  Open the details for the Build & Deploy workflow

    ![Text Description automatically generated](screenshots/screenshot-2022-12-28-8f5e83c2.png)

7.  Selecting any step in the Action workflow will show more details:

    ![Graphical user interface, text Description automatically generated](screenshots/screenshot-2022-12-28-338d5027.png)

8.  Wait for the workflow to complete successfully.

    ![Text Description automatically generated](screenshots/screenshot-2022-12-28-ffd5fa67.png)

9.  Navigate back to the Azure Static Web app, click itâ€™s URL and see the Blazor Web App is running as expected.

    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2022-12-28-4fa1cda8.png)
...
10. When searching for a Marvel Character, this throws an error though, which can be validated from the Inspect option of the browser:
    ...
    ![A screenshot of a computer Description automatically generated](screenshots/screenshot-2022-12-28-b0b0a6e2.png)
...
11. Remember at the start, where we configured the API calls at the Marvel Developer site, we needed to specify the source URLs from where the calls are allowed. This Azure Static Web App URL is not configured. (Hence why I didnâ€™t worry too much about including my APIKey as hard-coded string in the source code).
    ...
    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2022-12-28-16ff7f1a.png)
...
[![BuyMeACoffee](screenshots/screenshot-2022-12-28-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
