...
![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-18-31fb6b2a.png)
...
![Graphical user interface, Create Project](screenshots/screenshot-2024-05-18-c0fdabfe.png)
...
![Blazor WebAssembly default app in browser](screenshots/screenshot-2024-05-18-6376c36b.png)
...
![Web page layout is visible in the browser](screenshots/screenshot-2024-05-18-eace8fac.png)
...
![Graphical user interface, text, application, chat or text message Description automatically generated](screenshots/screenshot-2024-05-18-7c897836.png)
...
![Hot Reload](screenshots/screenshot-2024-05-18-af598345.png)
...
![Update after Hot Reload](screenshots/screenshot-2024-05-18-8b9a3021.png)
...
![Add bind-value parameter to text field](screenshots/screenshot-2024-05-18-d9480a36.png)
...
![AAdd onclick event for button](screenshots/screenshot-2024-05-18-5feb7c8f.png)
...
![Code snippet for button action](screenshots/screenshot-2024-05-18-5fc9e8a8.png)
...
![Hot Reload can't handle code changes](screenshots/screenshot-2024-05-18-5f1e4b86.png)
...
![Console.WriteLine is working as expected](screenshots/screenshot-2024-05-18-da22b543.png)
...
![Marvel Developer Site Home Page](screenshots/screenshot-2024-05-18-4f9a2349.png)
...
![API rate limits and domains](screenshots/screenshot-2024-05-18-47c6d979.png)
...
![Marvel API documentation site](screenshots/screenshot-2024-05-18-50eb88c8.png)

![nameStartsWith API Example](screenshots/screenshot-2024-05-18-2265117a.png)

![Limit the result set parameter to 50](screenshots/screenshot-2024-05-18-427ba28a.png)

![API response codes and try-out button](screenshots/screenshot-2024-05-18-360bd5d8.png)

6.  Click the â€œTry it outâ€ button. The result shows the outcome + the exact URL that was used:

![API Response Body in JSON](screenshots/screenshot-2024-05-18-4d64c949.png)
...
![Http Nuget Package](screenshots/screenshot-2024-05-18-3462a674.png).
...
```
![Add Scoped Service for HTTPClient](screenshots/screenshot-2024-05-18-96b9a1b4.png)
...
![Add Service for HTTPClient](screenshots/screenshot-2024-05-18-5d648ed1.png)
...
![HttpClient Dependency Injection](screenshots/screenshot-2024-05-18-f4b5871e.png)
...
![Marvel Characters JSON Response](screenshots/screenshot-2024-05-18-31bb1d9b.png)
...
![Text Description automatically generated](screenshots/screenshot-2024-05-18-2e723304.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2024-05-18-23f4f21c.png)
...
![MarvelResult Class](screenshots/screenshot-2024-05-18-c1624f39.png)
...
```
![Add Model data to Razor Page](screenshots/screenshot-2024-05-18-10d6034c.png)
...
![Adding using statement to point to Models subfolder](screenshots/screenshot-2024-05-18-f7c29b82.png)

Where now the Class gets nicely recognized

![MarvelResults recognized](screenshots/screenshot-2024-05-18-1597bf39.png)
...
![API Call snippet to Marvel back-end](screenshots/screenshot-2024-05-18-1edaf9ad.png)
...
![Disable Nullable Check for Project](screenshots/screenshot-2024-05-18-0b49c1da.png)
...
![Graphical user interface, website Description automatically generated](screenshots/screenshot-2024-05-18-88de5977.png)
...
1.  Open FlipMarvel.razor page; First thing we need to change, is the Page Routing, pointing to the â€œ/flipâ€ routing directory instead of the â€œ/â€, as that one is linked to the index.razor page.  
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-18-9b7d28f8.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2024-05-18-5ee912eb.png)
...
1.  Next, we add a class for the flip-card-back, where we will show the Marvel character name and description.   
    ...
    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2024-05-18-1ecbeef2.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2024-05-18-e436e152.png)

1.  Search for a character, and see the outcome cards:

![Graphical user interface Description automatically generated](screenshots/screenshot-2024-05-18-efb1bdd8.png)
...
![Text Description automatically generated](screenshots/screenshot-2024-05-18-12f7b192.png)
...
![Chart Description automatically generated with medium confidence](screenshots/screenshot-2024-05-18-e8c45d2f.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2024-05-18-2ce3432b.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2024-05-18-65ecbfd6.png)
...
![Graphical user interface, application Description automatically generated](screenshots/screenshot-2024-05-18-72687fbb.png)
...
![A screenshot of a computer Description automatically generated with medium confidence](screenshots/screenshot-2024-05-18-36962b2d.png)
...
1.  From the Azure Portal, create new resource / static web app  
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-18-4aae45d5.png)
...
-   Region = any region of your choice
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-18-62941ae1.png)
...
1.  Scroll down and authenticate to GitHub; Next, select your source repo in Github where the code is stored (the one we just created)
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-18-dbd525c0.png)
...
2.  Click Build Details to provide more parameters regarding the Blazor app itself. Note you need to change the default App location from /Client to /, since our source code is in the root of the Blazor Web Assembly, without using ASP.Net hosted back-end.
    ...
    ![Graphical user interface, application, email Description automatically generated](screenshots/screenshot-2024-05-18-a5c753e9.png)

3.  Once published, it will trigger a GitHub Actions pipeline to publish the actual content

    ![](screenshots/screenshot-2024-05-18-d30b17e9.png)
...
4.  The YAML pipeline code is stored in the .github/workflows/ subfolder within the GitHub repository. You shouldnâ€™t need to update this file though. It just works out-of-the-box.
    ...
    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2024-05-18-65639483.png)

5.  Check in Actions whatâ€™s happening:

    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2024-05-18-f50eb218.png)

6.  Open the details for the Build & Deploy workflow

    ![Text Description automatically generated](screenshots/screenshot-2024-05-18-8f5e83c2.png)

7.  Selecting any step in the Action workflow will show more details:

    ![Graphical user interface, text Description automatically generated](screenshots/screenshot-2024-05-18-338d5027.png)

8.  Wait for the workflow to complete successfully.

    ![Text Description automatically generated](screenshots/screenshot-2024-05-18-ffd5fa67.png)

9.  Navigate back to the Azure Static Web app, click itâ€™s URL and see the Blazor Web App is running as expected.

    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-18-4fa1cda8.png)
...
10. When searching for a Marvel Character, this throws an error though, which can be validated from the Inspect option of the browser:
    ...
    ![A screenshot of a computer Description automatically generated](screenshots/screenshot-2024-05-18-b0b0a6e2.png)
...
11. Remember at the start, where we configured the API calls at the Marvel Developer site, we needed to specify the source URLs from where the calls are allowed. This Azure Static Web App URL is not configured. (Hence why I didnâ€™t worry too much about including my APIKey as hard-coded string in the source code).
    ...
    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2024-05-18-16ff7f1a.png)
...
[![BuyMeACoffee](screenshots/screenshot-2024-05-18-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
