...
![Current Docker Desktop](screenshots/screenshot-2020-07-05-13bd02ab.jpg)
...
![Docker Desktop Running](screenshots/screenshot-2020-07-05-0c18658c.jpg)
...
![Docker Info](screenshots/screenshot-2020-07-05-b13c03cc.jpg)
...
```
![Restore Docker Image](screenshots/screenshot-2020-07-05-87a776f0.jpg)
...
docker images
```
![Restore Docker Image](screenshots/screenshot-2020-07-05-aee2cfa1.jpg)
...
Docker Login Azure
```
![Authenticate to Azure](screenshots/screenshot-2020-07-05-86961e5d.jpg)
...
![Create ACI Context](screenshots/screenshot-2020-07-05-fb1e808b.jpg)

If you don't want to use an existing Resource Group, you can create a new one:

![Create ACI Context new RG](screenshots/screenshot-2020-07-05-43872c02.jpg)
...
![Create ACI Context existing RG](screenshots/screenshot-2020-07-05-51aaf964.jpg)
...
![Docker run container](screenshots/screenshot-2020-07-05-9392b6d3.jpg)
...
![ACI is running](screenshots/screenshot-2020-07-05-841512b2.jpg)
...
![ACI validate in browser](screenshots/screenshot-2020-07-05-7136e153.jpg)
...
![ACI validate in portal](screenshots/screenshot-2020-07-05-c95290a1.jpg)
...
![ACI context creation](screenshots/screenshot-2020-07-05-4ae87fbd.jpg)

2) Run the Docker Container, pointing to the Azure Container Registry image 

![run ACR image](screenshots/screenshot-2020-07-05-613755a4.jpg)
...
![config.json](screenshots/screenshot-2020-07-05-406a84ee.jpg)

Apparently it is safe to remove the section "CredHelpers", saving the file and running the "Docker Run" again:

![run ACR image](screenshots/screenshot-2020-07-05-96004182.jpg)
...
![az acr login](screenshots/screenshot-2020-07-05-b1bde042.jpg)

Let's validate once more by initiating "docker ps", which shows the following:

![docker ps](screenshots/screenshot-2020-07-05-2a31c07b.jpg)
...
![workload runs](screenshots/screenshot-2020-07-05-8c54c033.jpg)

and lastly, checking back on what it looks like from the Azure Portal

![ACI running in portal](screenshots/screenshot-2020-07-05-84f98824.jpg)
...
[![BuyMeACoffee](screenshots/screenshot-2020-07-05-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
