...
![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-30-31fb6b2a.png)
...
![Graphical user interface, Create Project](screenshots/screenshot-2024-05-30-c0fdabfe.png)
...
![Blazor default web app in browser](screenshots/screenshot-2024-05-30-6376c36b.png)
...
![Counter Page](screenshots/screenshot-2024-05-30-b86eb30f.png)
...
![Counter Component embedded in Home Page](screenshots/screenshot-2024-05-30-8ca81ccf.png)
...
![CConferenceSession Class](screenshots/screenshot-2024-05-30-b1097be6.png)
...
![Add New Scaffolded Item](screenshots/screenshot-2024-05-30-1ea8bf44.png)

4. From the list of options, select **Razor Component** and **Razor Components Using Entity Framework (CRUD)**

![Add New Scaffolded Item](screenshots/screenshot-2024-05-30-fc5bd115.png)
...
![Add New Scaffolded Item](screenshots/screenshot-2024-05-30-89b9a0e9.png)
...
![Scaffolded create page](screenshots/screenshot-2024-05-30-da1eb843.png), and check the first couple of lines:
...
![Create Entity Framework Migration](screenshots/screenshot-2024-05-30-94e56821.png)
...
![Update Entity Framework Database](screenshots/screenshot-2024-05-30-fc8d8118.png)
...
![Editing Page for Conference Session items](screenshots/screenshot-2024-05-30-fc7590a8.png)
...
![Create new DB Record](screenshots/screenshot-2024-05-30-7db1d29d.png)
...
![Delete DB Record](screenshots/screenshot-2024-05-30-347abe08.png)
...
1.  From the Azure Portal, create new resource / static web app  
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-30-4aae45d5.png)
...
-   Region = any region of your choice
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-30-62941ae1.png)
...
1.  Scroll down and authenticate to GitHub; Next, select your source repo in Github where the code is stored (the one we just created)
    ...
    ![Graphical user interface, text, application Description automatically generated](screenshots/screenshot-2024-05-30-dbd525c0.png)
...
2.  Click Build Details to provide more parameters regarding the Blazor app itself. Note you need to change the default App location from /Client to /, since our source code is in the root of the Blazor Web Assembly, without using ASP.Net hosted back-end.
    ...
    ![Graphical user interface, application, email Description automatically generated](screenshots/screenshot-2024-05-30-a5c753e9.png)

3.  Once published, it will trigger a GitHub Actions pipeline to publish the actual content

    ![](screenshots/screenshot-2024-05-30-d30b17e9.png)
...
4.  The YAML pipeline code is stored in the .github/workflows/ subfolder within the GitHub repository. You shouldnâ€™t need to update this file though. It just works out-of-the-box.
    ...
    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2024-05-30-65639483.png)

5.  Check in Actions whatâ€™s happening:

    ![Graphical user interface, text, application, email Description automatically generated](screenshots/screenshot-2024-05-30-f50eb218.png)

6.  Open the details for the Build & Deploy workflow

    ![Text Description automatically generated](screenshots/screenshot-2024-05-30-8f5e83c2.png)

7.  Selecting any step in the Action workflow will show more details:

    ![Graphical user interface, text Description automatically generated](screenshots/screenshot-2024-05-30-338d5027.png)

8.  Wait for the workflow to complete successfully.

    ![Text Description automatically generated](screenshots/screenshot-2024-05-30-ffd5fa67.png)
...
[![BuyMeACoffee](screenshots/screenshot-2024-05-30-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
