...
![Investigating_App_Service](screenshots/screenshot-2026-03-14-090607.png)

Followed by **looking into the metrics**

![Investigating_Metrics](screenshots/screenshot-2026-03-14-090726.png)

To then provide **a summary** of the findings and observations, **INCLUDING CHART VIEWS**

![Investigating_charts](screenshots/screenshot-2026-03-14-090957.png)

Detailed Root Cause Analysis

![Investigating_summary](screenshots/screenshot-2026-03-14-091106.png)

and detailed description of **what happened** and **Recommended actions**

![Investigating_summary](screenshots/screenshot-2026-03-14-091159.png)

It identified the root cause being an **identity** problem, where the Web App could not connect to Cosmos DB. 

![Investigating_summary](screenshots/screenshot-2026-03-14-091431.png)
...
![Investigating_diagnose_complete](screenshots/screenshot-2026-03-14-091606.png)
...
![acknowledge_fix](screenshots/screenshot-2026-03-14-091835.png)
...
![acknowledge_fix](screenshots/screenshot-2026-03-14-092204.png)
...
[![BuyMeACoffee](screenshots/screenshot-2026-03-14-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
