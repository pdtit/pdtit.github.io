...
![Visual Studio Installer](screenshots/screenshot-2020-11-10-ff8a2109.png)
...
![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-5abe34b0.png)

3. **Press Create**; in the next step, from the top, select **.NET Core** and **ASP.NET Core 5.0** 

![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-22188342.png)
...
![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-c1ac954c.png)
...
![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-6a91a2df.png)

2. From the **Publish** wizard Target step, select **Azure**; click Next 

![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-9a28ca8d.png)

3. From the wizard's Specific Target step, select **Azure App Service (Linux)**; click Next

![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-4b2d020a.png)

4. From the wizard's App Service step, Click the **+** sign to **create a new **Azure App Service** 

![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-e2413475.png)
...
![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-efeddd6d.png)

5. Validate all the settings, and confirm by pressing **Finish**

![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-4684ee27.png)

6. From the summary page, press **Publish**; This starts the publishing process. 

![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-9a353f9b.png)

7. Wait for it to complete successfully. The process can be viewed from the **Output window**

![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-6effce7b.png)
...
![ASP.NET Web App Template](screenshots/screenshot-2020-11-10-0a207712.png)
...
[![BuyMeACoffee](screenshots/screenshot-2020-11-10-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
