...
![GitHub Copilot agent mode in VS Code](screenshots/placeholder-copilot-agent-mode.png)
...
![The phased migration plan drafted with Copilot](screenshots/placeholder-migration-plan.png)
...
![The GitHub Actions build and deploy workflow running green](screenshots/placeholder-actions-run-green.png)
...
![The DNS records configured at the registrar](screenshots/placeholder-dns-records.png)
