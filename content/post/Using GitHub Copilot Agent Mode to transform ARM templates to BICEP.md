...
![Current ARM Templates](../images/2025-07-04-templates.png)
...
![Agent Mode Prompt Used](../images/2025-07-04-prompt.png)
...
![Agent Mode Starting](../images/2025-07-04-start.png)
...
![Agent Mode inspecting files](../images/2025-07-04-start-filecheck.png)
...
![Agent Mode creating main.bicep](../images/2025-07-04-bicep.png)
...
![Agent Mode pending task](../images/2025-07-04-continue.png)
...
![Agent Mode conversion](../images/2025-07-04-templates-list.png)
...
![Agent Mode updating file links](../images/2025-07-04-bicep-templatelinks.png)
...
![Agent Mode create azure.yaml](../images/2025-07-04-bicep-azure-yaml.png)

12. Last, it also created a *main.parameters.json*, to capture any specific Parameters for the deployment. 

![Agent Mode create main.parameters.json](../images/2025-07-04-bicep-main.png)
...
![Agent Mode detecting an issue](../images/2025-07-04-bicep-error.png)
...
![Agent Mode creating conversion documentation](../images/2025-07-04-bicep-conversion.png)
...
![Agent Mode creating readme](../images/2025-07-04-readme.png)
...
![Agent Mode Chat description](../images/2025-07-04-taskvalidation1.png)

18. As well as adding additional details on the **task validation**.

![Agent Mode creating task validation](../images/2025-07-04-taskvalidation.png)

19. Finishing with describing different ways on how to run the actual deployment, using **azd**, **Azure CLI** and **Azure PowerShell**. 

![Agent Mode explaining how to run the deployment](../images/2025-07-04-ready.png)

20. Last step was running the deployment, and this worked without any hiccups! 

![Deployment completed](../images/2025-07-04-works.png)
