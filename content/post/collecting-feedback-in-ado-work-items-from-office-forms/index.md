...
![Office Form](screenshots/screenshot-2023-03-26-2b1ef5a1.png)
...
![Boards and Process](screenshots/screenshot-2023-03-26-df0c5d80.png)
1. This shows a list of default Azure Boards processes (Basic, Agile, Scrum, CMMI)
![Boards Process](screenshots/screenshot-2023-03-26-7cb68522.png)
...
![Create inherited process](screenshots/screenshot-2023-03-26-df7aac9a.png)
...
![Work Item Types](screenshots/screenshot-2023-03-26-8b3dc29d.png)
...
![Work Item Type Customization](screenshots/screenshot-2023-03-26-06976188.png)
...
![Create New Project](screenshots/screenshot-2023-03-26-3e366779.png)
1. Once the project got created, navigate to **Boards**. Here, click **New Work Item**, notice the new Work Item type is available.
![Custom Work Item Type](screenshots/screenshot-2023-03-26-05c895c3.png)
...
![Custom Work Item Type](screenshots/screenshot-2023-03-26-1e6b2800.png)
...
![Create Azure Logic Apps Resource](screenshots/screenshot-2023-03-26-a89192c1.png)
...
![Blank Logic App](screenshots/screenshot-2023-03-26-df97dc64.png)
...
![Office Forms Trigger](screenshots/screenshot-2023-03-26-cecb3bde.png)
...
![ADO New work item action](screenshots/screenshot-2023-03-26-7aa8d892.png)
1. Complete the fields, selecting your **DevOps Organization**, the **DevOps Project** and the **Work Item Type** as created earlier.
![ADO New work item action](screenshots/screenshot-2023-03-26-c8b8390a.png)
1. Now, we map the custom fields, by selecting **Add new parameter**, and selecting **Other Fields**.
![Parameters / Other Fields](screenshots/screenshot-2023-03-26-16f51563.png)
...
![Dynamic Content Results](screenshots/screenshot-2023-03-26-aae62c2e.png)
...
![Get Response Details](screenshots/screenshot-2023-03-26-0c079d55.png)
...
![Get Response Id](screenshots/screenshot-2023-03-26-d570537a.png)
...
![Select Response details](screenshots/screenshot-2023-03-26-772841b5.png)
...
![Map Response details](screenshots/screenshot-2023-03-26-739aae45.png)
...
![Collect Form Responses](screenshots/screenshot-2023-03-26-e557cb7e.png)
...
![Logic Apps Run History](screenshots/screenshot-2023-03-26-1ee745e5.png)
1. The Forms completion resulted in a **successful workflow trigger**. Select the line, which opens a more detailed view.
![Logic Apps detailed Run History](screenshots/screenshot-2023-03-26-2b672d60.png).
1. Last, return to the Azure DevOps Project, navigate to Boards and open Work Items. Notice the **newly created Work Item**.
![Logic Apps created Work Item](screenshots/screenshot-2023-03-26-52dd6fba.png)
1. Open the item, to see how the custom fields got completed.
![Logic Apps created Work Item details](screenshots/screenshot-2023-03-26-bc418eb7.png)
...
[![BuyMeACoffee](screenshots/screenshot-2023-03-26-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
