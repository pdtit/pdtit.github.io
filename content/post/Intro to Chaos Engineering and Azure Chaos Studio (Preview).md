...
![Chaos Monkey Logo](../images/screenshot-2023-08-27-f4513d5f.png)
...
![Microsoft Chaos Resource Provider](../images/screenshot-2023-08-27-3dba02fd.png)
...
![Chaos Studio MI](../images/screenshot-2023-08-27-b7925536.png)
...
![Chaos App Insights](../images/screenshot-2023-08-27-79f3265f.png) 

6. From the Azure Portal, search for **Azure Chaos Studio**. 

![Welcome to Chaos Studio](../images/screenshot-2023-08-27-8edd1900.png) 

7. Select **Onboard Resources**. This brings you to the **Targets** section of the blade.

![Chaos Studio Targets](../images/screenshot-2023-08-27-52ecf869.png)
...
![Chaos Studio VM Target](../images/screenshot-2023-08-27-936a94a1.png)
...
![Chaos Studio VM Agent Target](../images/screenshot-2023-08-27-3a266713.png)
...
![Chaos Studio non-VM Agent Target](../images/screenshot-2023-08-27-3b3c9221.png)

This opens the Enable service direct targets blade. Click **Review and Enable** to complete the step. 

![Chaos Studio non-VM Agent Target](../images/screenshot-2023-08-27-1d3b4fde.png)
...
![Chaos Studio Experiment](../images/screenshot-2023-08-27-db463abf.png)
...
![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-8f2775b2.png)
...
![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-ffa6feca.png)

4. Click **Next** to open the **Experiment Designer**

![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-a37f8e43.png)
...
![Chaos Studio Faults](../images/screenshot-2023-08-27-0e39d2a6.png)
...
![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-0486f59f.png)

6. Next, allocate the Azure Target Resource. In our example, select the VM you deployed earlier as sample target.

![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-470851fe.png)

7. A new Experiment Resource got created.

![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-a0323747.png)
...
![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-215d46e9.png)
...
![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-bdb604db.png)
...
![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-6578869d.png)

11. Wait for the Experiment to change to **Running** state.

![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-28c874a1.png)
...
![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-ffbe69ab.png)
...
![Chaos Studio Experiment Basics](../images/screenshot-2023-08-27-53ec94b1.png)
...
[![BuyMeACoffee](../images/screenshot-2023-08-27-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
