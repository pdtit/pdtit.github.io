...
![Current ARM Templates](screenshots/screenshot-2025-07-12-677ae48c.png)
...
![Agent Mode Prompt Used](screenshots/screenshot-2025-07-12-0e6d3c1f.png)
...
![Agent Mode Starting](screenshots/screenshot-2025-07-12-9563c155.png)
...
![Agent Mode inspecting files](screenshots/screenshot-2025-07-12-23d6f25c.png)
...
![Agent Mode creating main.bicep](screenshots/screenshot-2025-07-12-048d528f.png)
...
![Agent Mode pending task](screenshots/screenshot-2025-07-12-9f313718.png)
...
![Agent Mode conversion](screenshots/screenshot-2025-07-12-cc406a5d.png)
...
![Agent Mode updating file links](screenshots/screenshot-2025-07-12-3a52cde6.png)
...
![Agent Mode create azure.yaml](screenshots/screenshot-2025-07-12-c58c585e.png)

12. Last, it also created a *main.parameters.json*, to capture any specific Parameters for the deployment. 

![Agent Mode create main.parameters.json](screenshots/screenshot-2025-07-12-52ae46b8.png)
...
![Agent Mode validating infra](screenshots/2025-07-04-bicep-error.png)
...
![Agent Mode detecting an issue](screenshots/screenshot-2025-07-12-7c9e3eae.png)
...
![Agent Mode creating conversion documentation](screenshots/screenshot-2025-07-12-233210a1.png)
...
![Agent Mode creating readme](screenshots/screenshot-2025-07-12-ea367bd4.png)
...
![Agent Mode Chat description](screenshots/screenshot-2025-07-12-12b1b132.png)

18. As well as adding additional details on the **task validation**.

![Agent Mode creating task validation](screenshots/screenshot-2025-07-12-8a5606f6.png)

19. Finishing with describing different ways on how to run the actual deployment, using **azd**, **Azure CLI** and **Azure PowerShell**. 

![Agent Mode explaining how to run the deployment](screenshots/screenshot-2025-07-12-1a21a2ce.png)

20. Last step was running the deployment, and this worked without any hiccups! 

![Deployment completed](screenshots/screenshot-2025-07-12-b01b0623.png)
...
[![BuyMeACoffee](screenshots/screenshot-2025-07-12-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
