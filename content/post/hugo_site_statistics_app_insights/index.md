...
![Create Application Insights](screenshots/screenshot-2020-04-26-bdfb5aa6.jpg)
...
- Complete the necessary parameters to get this resource created:
    ...
    ![Create Application Insights](screenshots/screenshot-2020-04-26-b38f5936.jpg)

- Wait for the resource to get created. Once created, open the Application Insight blade:

![Create Application Insights](screenshots/screenshot-2020-04-26-cd72528e.jpg)
...
![Create Application Insights](screenshots/screenshot-2020-04-26-64a347c5.jpg)
...
![Create Application Insights](screenshots/screenshot-2020-04-26-260c292a.jpg)
...
![Application Insights Usage](screenshots/screenshot-2020-04-26-12ca0bfd.jpg)
...
![Application Insights Users](screenshots/screenshot-2020-04-26-aedfd23d.jpg)

- For example, changing the time window to **7 days**, changes the view to this in my example: 

![Application Insights Users_7days](screenshots/screenshot-2020-04-26-79643c4c.jpg)
...
![Application Insights Users by country](screenshots/screenshot-2020-04-26-31933530.jpg)

- **Scrolling more down** shows yet another summary view, summarized **by (active) session**:

![Application Insights Users by session](screenshots/screenshot-2020-04-26-b41ff2f3.jpg)
...
![Application Insights session timeline](screenshots/screenshot-2020-04-26-7f2aeff7.jpg)

- Back from the **Usage** menu of Application Insights, **select** **Events**

![Application Insights Events](screenshots/screenshot-2020-04-26-119b51ae.jpg)
...
![Application Insights Event Statistics](screenshots/screenshot-2020-04-26-1fbb7c07.jpg)
...
![Application Insights End To End Transaction Details](screenshots/screenshot-2020-04-26-27c05771.jpg)

- From this view, select **All available telemetry information for this session**, under the **Related items** section:

![Application Insights Related Items](screenshots/screenshot-2020-04-26-f1e34ff1.jpg)

- Which in turn exposes additional details about each and every item viewed during that specific session 

![Application Insights Telemetry Search](screenshots/screenshot-2020-04-26-fa71f594.jpg)
...
[![BuyMeACoffee](screenshots/screenshot-2020-04-26-17f576e7.png)](https://www.buymeacoffee.com/pdtit)
